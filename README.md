...
The R^2 value of the model was obtained by training and verifying the model based on the months 2018-08 and 2018-09. R^2, also known as the coefficient of determination, is a statistical measure that tells how similar two data series are: in this case, the predictions vs. the observations for bike availability. 
